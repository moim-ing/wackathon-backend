...
class BannedUserCannotRegisterException :
    ParticipationException(error = ParticipationErrorCode.BANNED_USER_CANNOT_REGISTER)

class SessionNotFoundException :
    ParticipationException(error = ParticipationErrorCode.SESSION_NOT_FOUND)

class ClassNotFoundException :
    ParticipationException(error = ParticipationErrorCode.CLASS_NOT_FOUND)